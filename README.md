...
| <a name="video"></a> ([`schema:Event`](https://schema.org/Event), [`openactive:FacilityUse`](undefinedFacilityUse), [`schema:Brand`](https://schema.org/Brand)) <br/>  `beta:video` | [`schema:VideoObject`](https://schema.org/VideoObject) | [#88](https://github.com/openactive/modelling-opportunity-data/issues/88) | An related video object. |
