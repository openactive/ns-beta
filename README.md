...
|---------------------|-----------------|------------|---------------------------------------------------------------------|
| <a name="facilitySetting"></a> ([`oa:FacilityUse`](https://openactive.io/FacilityUse)) <br/>  `beta:facilitySetting` | [`beta:FacilitySettingType`](https://openactive.io/ns-beta#FacilitySettingType) | [#1](https://github.com/openactive/facility-types/issues/1) | Whether the facility is indoor, outdoor, or is able to be either. |
